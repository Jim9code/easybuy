					...
					<div>
						...
						<div class="mt-1.5 relative rounded-xl shadow-sm">
							...
							<input type="password" name="password" id="password" required placeholder="Min 8 characters"
								class="block w-full pl-10 pr-4 py-3 rounded-xl border border-[#D8C9B5] bg-[#FAF6EE] text-sm text-[#191917] placeholder-[#9C9283] focus:outline-none focus:ring-2 focus:ring-[#191917] focus:border-[#191917] transition" />
						</div>
					</div>
