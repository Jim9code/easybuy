<x-layout>
	...
	<section id="simulator" class="relative overflow-hidden py-6 sm:py-8 lg:py-10 bg-[#FAF6EE] lg:min-h-[calc(100vh-4rem)] lg:max-h-[860px] flex items-center">
		...
		<!-- Giant Cannaray Sun Yellow Backdrop (Centered on mobile, crest at 46% on desktop) -->
		<div id="hero-sun-backdrop" class="pointer-events-none absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 lg:left-[46%] lg:translate-x-0 w-[360px] sm:w-[540px] lg:w-[950px] xl:w-[1050px] aspect-square rounded-full bg-[#FFD000] z-0 transition-transform duration-700 ease-out"></div>
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full relative z-10">
			<div class="grid lg:grid-cols-12 gap-8 lg:gap-8 items-center">
				...
				<div class="lg:col-span-6 flex flex-col justify-center space-y-4 lg:space-y-5 scroll-reveal">
					...
					<!-- Minimal & Professional Procurement Intake Text Box (Spaced down from CTA) -->
					<div class="pt-4 sm:pt-5 lg:pt-7 max-w-xl">
						<div class="clay-card rounded-2xl p-3.5 sm:p-4 border border-[#D8C9B5] shadow-xs bg-[#F2EAE0]">
							...
							<div class="relative">
								<textarea id="prompt-input" rows="3" 
									...
									class="w-full rounded-xl bg-[#FAF6EE] p-3 text-xs text-[#191917] placeholder:text-[#9C9283] border border-[#D8C9B5] focus:outline-none focus:ring-2 focus:ring-[#FFD000] transition resize-none font-mono leading-relaxed shadow-inner">We are onboarding 5 software developers. I need: 5 ergonomic mesh chairs, 5 electric standing desks, 10 4K 27-inch monitors with USB-C, and 5 mechanical keyboard combos. Budget cap: $6,500.</textarea>
							</div>
							...
							<div class="mt-2.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-0.5">
								...
								<div class="flex items-center gap-1.5 text-3xs text-[#7A7365] overflow-x-auto pb-1 sm:pb-0 max-w-full">
									<span class="font-bold text-[#9C9283] uppercase tracking-wider whitespace-nowrap">Sample:</span>
									<button onclick="loadPresetPrompt('dev_workstation')" class="px-2 py-1 rounded-md bg-[#FAF6EE] border border-[#D8C9B5] hover:text-[#191917] hover:border-[#191917] transition cursor-pointer whitespace-nowrap font-medium flex items-center gap-1">
									...
									<button onclick="loadPresetPrompt('janitorial')" class="px-2 py-1 rounded-md bg-[#FAF6EE] border border-[#D8C9B5] hover:text-[#191917] hover:border-[#191917] transition cursor-pointer whitespace-nowrap font-medium flex items-center gap-1">
										<svg class="h-3 w-3 text-[#191917]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
											<path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
										</svg>
										<span>Office Restock</span>
									</button>
									<button onclick="loadPresetPrompt('design_studio')" class="px-2 py-1 rounded-md bg-[#FAF6EE] border border-[#D8C9B5] hover:text-[#191917] hover:border-[#191917] transition cursor-pointer whitespace-nowrap font-medium flex items-center gap-1">
										<svg class="h-3 w-3 text-[#191917]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								...
								<button id="simulate-btn" onclick="startSourcingSimulation()" 
									class="w-full sm:w-auto bg-[#191917] hover:bg-[#333333] text-[#FAF6EE] px-5 py-2.5 sm:py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer transition active:scale-95 shadow-xs whitespace-nowrap">
							...
							<div id="consolidated-box-result" class="hidden mt-3 p-3 bg-[#FAF6EE] rounded-xl border border-[#FFD000] shadow-sm animate-fade-in">
								<div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
									<div class="flex items-center gap-2">
										<span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#FFD000] text-[#191917]">
											<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
												<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />
											</svg>
										</span>
										<div>
											<h4 class="text-2xs font-bold text-[#191917]">Unified Quote Ready • Connecting to Ask Easy</h4>
											<p class="text-3xs text-[#5C5549]">Single Consolidated Invoice Delivery.</p>
										</div>
									</div>
									<div class="flex items-center gap-1.5 w-full sm:w-auto justify-end">
										<button onclick="startSourcingSimulation()" class="bg-[#FFD000] text-[#191917] px-3 py-1.5 rounded-lg text-3xs font-extrabold shadow-xs hover:bg-[#F2C200] whitespace-nowrap cursor-pointer w-full sm:w-auto text-center">
											Continue &rarr;
										</button>
									</div>
								</div>
					...
					<!-- Carousel Dash Indicators (Matching herodesign.png) -->
					<div class="flex items-center gap-2.5 pt-1 sm:pt-2">
						<span class="h-1 w-8 sm:w-9 rounded-full bg-[#191917] transition-all cursor-pointer"></span>
						<span class="h-1 w-8 sm:w-9 rounded-full bg-[#E0D3C1] hover:bg-[#9C9283] transition-all cursor-pointer"></span>
						<span class="h-1 w-8 sm:w-9 rounded-full bg-[#E0D3C1] hover:bg-[#9C9283] transition-all cursor-pointer"></span>
						<span class="h-1 w-8 sm:w-9 rounded-full bg-[#E0D3C1] hover:bg-[#9C9283] transition-all cursor-pointer"></span>
					</div>
			...
			<div class="relative max-w-6xl mx-auto flex flex-wrap justify-center items-start gap-4 sm:gap-6 lg:gap-7 pt-4 pb-8">
				...
				<div class="scroll-reveal-pop delay-250 w-full sm:w-auto">
					<div class="group relative w-full sm:w-[260px] rounded-2xl p-4 sm:p-4.5 bg-[#FAF6EE] border border-[#E0D3C1]/90 shadow-xs hover:shadow-2xl transition-all duration-300 transform sm:-rotate-2 sm:hover:rotate-0 hover:scale-105 sm:hover:scale-110 hover:z-30 cursor-pointer select-none sm:-translate-y-2">
						...
						<div class="flex items-center gap-0.5 text-[#FFD000] text-xs mb-2">★★★★★</div>
						<p class="text-xs font-bold text-[#191917] leading-snug mb-1.5">
							“Saved $38,000 on our commercial studio fit-out. Wholesale pricing is 100% genuine.”
						</p>
						<p class="text-3xs text-[#7A7365] leading-relaxed mb-3">
			...
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 pb-10 sm:pb-16 border-b border-[#2D2D29]">
				...
				<div class="lg:col-span-5 space-y-4">
					<a href="{{ url('/') }}" class="flex items-center gap-3 group inline-flex">
						<span class="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-[#FFD000] text-[#191917] font-black text-2xs sm:text-xs uppercase shadow-xs group-hover:scale-105 transition-transform">
							EB
						</span>
	...
	<script>
		...
		// Preset prompt texts
		const PRESETS = {
			dev_workstation: "We are onboarding 5 software developers. I need: 5 ergonomic mesh chairs, 5 electric standing desks, 10 4K 27-inch monitors with USB-C, and 5 mechanical keyboard combos. Budget cap: $6,500.",
